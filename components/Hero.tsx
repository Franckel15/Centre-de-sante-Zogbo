...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative pt-24 lg:pt-32 pb-16 lg:pb-32 overflow-hidden bg-gradient-to-br from-teal-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-teal-950 min-h-[90vh] flex items-center transition-colors duration-300">
      {/* Background Shapes */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <Reveal delay={0.4}>
                <div className="flex items-center justify-center lg:justify-start gap-8 pt-4 opacity-80 grayscale hover:grayscale-0 transition-all duration-500">
             ...
             <div className="relative w-full max-w-lg lg:max-w-full">
                ...
                <div className="animate-float relative z-10">
                    <EditableImage
                        ...
                        className="rounded-3xl shadow-2xl w-full object-cover object-center h-[450px] lg:h-[550px] border-4 border-white dark:border-gray-800 bg-gray-100 dark:bg-gray-800"
                    />
                    
                    {/* Floating Card 1: Urgences */}
                    <div className="absolute -bottom-24 left-4 md:-left-8 bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 animate-bounce hidden md:block" style={{ animationDuration: '3s' }}>
                    ...
                    <div className="absolute top-10 -right-10 bg-white/90 dark:bg-gray-800/90 backdrop-blur p-4 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 hidden md:block transform hover:scale-105 transition-transform cursor-pointer">
