            ...
            <div className="space-y-4 text-sm overflow-y-auto pr-1 min-w-0 flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-600 min-w-0">
                  ...
                  <span className="font-bold text-gray-900 dark:text-white break-words text-base block">{viewingAppointment.name}</span>
                </div>
                <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-600 min-w-0">
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-xl border border-gray-100 dark:border-gray-600 min-w-0">
                ...
                <p className="text-gray-700 dark:text-gray-300 italic whitespace-pre-wrap break-words [overflow-wrap:anywhere] leading-relaxed">
                  {viewingAppointment.reason || "Aucun motif particulier précisé."}
                </p>
              </div>
